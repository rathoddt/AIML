...
Log in to Google Cloud Platform using the credentials provided for the lab. Ensure you are using a private/incognito browser window to avoid cached login issues.

On the Welcome to your new account screen, review the text and click Accept. In the message that pops up once you're signed in, check to agree to the terms of service, choose your country of residence, and click Agree and Continue.
